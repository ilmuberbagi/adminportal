...
<head>
    ...
    <title><?php echo isset($title)?$title:'Member Komunitas IBF'; ?></title>
</head>
                            ...
                            <table  cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block">
                                        <h3><?php if(isset($name)) echo $name; else echo 'Hey';?>, Selamat Datang di Komunitas Ilmi Berbagi Foundation!</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        <p>Selamat, Anda telah terdaftar sebagai <a href="<?php echo base_url();?>">Member Komunitas Ilmu Berbagi Foundation</a>.</p>
