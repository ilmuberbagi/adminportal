				...
				<div class="box box-success">
					<div class="box-body">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label>Tahun</label>
								<select name="member_reg_year" class="form-control select2" required>
									<?php for($a = 2011; $a<= date('Y'); $a++){?>
									<option value="<?php echo $a;?>" <?php echo $member[0]['member_reg_year'] == $a ? 'selected':'';?>><?php echo $a;?></option>
									<?php } ?>
								</select>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<select name="member_type[]" class="form-control select2" placeholder="Bisa lebih dari satu" multiple required>
									<?php if(!empty($types)){ 
										foreach($types as $t){?>
											<option value="<?php echo $t['member_type'];?>" <?php echo $xxx !== NULL && in_array($t['member_type'], $xxx) ? 'selected':'';?>><?php echo $t['member_type'];?></option>
									<?php }} ?>
								</select>
							</div>
